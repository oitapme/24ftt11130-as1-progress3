            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('posts.update', $post) }}">
                        ...
                        <div class="mt-4">
                            <div>
                                <label for="content_post">Full Post Content:</label>
                            </div>
                            <textarea name="content_post" id="content_post" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">{{ $post->content_post }}</textarea>
                        </div>
                        <div>
                            <div>
